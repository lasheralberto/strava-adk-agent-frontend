          ...
          {open ? (
            <>
              ...
              <motion.aside
                ...
                className="fixed inset-y-0 right-0 z-[10010] flex w-full max-w-[min(92vw,32rem)] flex-col border-l border-border bg-popover text-popover-foreground shadow-2xl"
              >
                        ...
                        return (
                          <li key={String(run.activity_id)} className="px-4 py-3">
                            <div className="flex items-start justify-between gap-2">
                              <span className="flex-1 truncate text-[13px] font-medium leading-snug text-foreground">
